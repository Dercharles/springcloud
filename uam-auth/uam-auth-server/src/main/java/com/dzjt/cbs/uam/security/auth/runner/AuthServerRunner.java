package com.dzjt.cbs.uam.security.auth.runner;

import com.dzjt.cbs.uam.security.auth.common.util.jwt.RsaKeyHelper;
import com.dzjt.cbs.uam.security.auth.configuration.KeyConfiguration;
...
public class AuthServerRunner implements CommandLineRunner {
    ...
    private static final String REDIS_USER_PRI_KEY = "UAM:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "UAM:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "UAM:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "UAM:AUTH:CLIENT:PUB";
