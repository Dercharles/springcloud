...
import com.uam.cache.parser.ICacheResultParser;
import com.uam.cache.parser.IKeyGenerator;
import com.uam.cache.parser.impl.DefaultKeyGenerator;
...
public class CacheAspect {
    ...
    @Pointcut("@annotation(com.uam.cache.annotation.Cache)")
    public void aspect() {
    }
